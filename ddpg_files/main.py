...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', default='MatlabEnv', type=str, help='open-ai gym environment')
    parser.add_argument('--Nr', default=64, type=int, help='Number of RIS elements')
    parser.add_argument('--H_size', default=16, type=int, help='Number of H elements')
    ...
    if args.env == 'MatlabEnv':
        env = MatlabEnv(Nr=args.Nr, H_size=args.H_size)
